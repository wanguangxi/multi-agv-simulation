...
int main(int argc, char **argv)
{
  ...
  if (argc != 2){ROS_ERROR("need master name as argument"); return -1;};
  robot_name = argv[1];

  velocity_publisher = masterNode.advertise<geometry_msgs::Twist>(robot_name+"/cmd_vel", 1);
